                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mx-auto custom_border">
                           ...
                           <?php echo form_open(); ?>
                                ...
                                <div class="col-md-9">
                                <input class="form-control" type="text" name="name" placeholder="Name of customer" required/>
                                </div>
                                ...
                                <div class="col-md-9">
                                <input class="form-control" type="number" name="qty" placeholder="Enter Quantity" required/>
                                </div>
